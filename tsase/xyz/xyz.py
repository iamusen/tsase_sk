...
class Viewer(tk.Frame):
	...
	def create_tk_variables(self):
		...
		self.radius.set(1.5)
		self.fps.set(5)
		self.repeat_x.trace('w', self.trace_entries)
		self.repeat_y.trace('w', self.trace_entries)
		self.repeat_z.trace('w', self.trace_entries)
		self.radius.trace('w', self.trace_entries)
		self.zoom.trace('w', self.trace_entries)
