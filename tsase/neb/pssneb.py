...
from tsase.neb.util import vmag2, vmag, vunit, vproj, vdot, sPBC
...
#2to3            raw_input('If you are not using mpirun, hit Enter to continue')
            input('If you are not using mpirun, hit Enter to continue')
